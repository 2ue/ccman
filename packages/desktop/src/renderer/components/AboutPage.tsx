      ...
      <div className="max-w-2xl w-full bg-white rounded-lg shadow-sm p-8">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-3">
            <a
              href="https://github.com/ccman/ccman"
              target="_blank"
            ...
            <a
              href="https://github.com/ccman/ccman/issues"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center text-blue-600 hover:text-blue-700 transition-colors"
            >
            ...
            <a
              href="https://github.com/ccman/ccman/blob/main/docs/%E9%9C%80%E6%B1%82%E5%88%86%E6%9E%90.md"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center text-blue-600 hover:text-blue-700 transition-colors"
            >
