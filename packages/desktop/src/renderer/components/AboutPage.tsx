    ...
    <div className="flex-1 overflow-y-auto bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 mb-2">ccman</h1>
        ...
        {/* 核心功能 */}
        <div className="mb-8">
          <h2 className="text-lg font-semibold tracking-tight text-gray-900 mb-3">核心功能</h2>
        ...
        {/* 社区链接 */}
        <div className="mb-8">
          <h2 className="text-lg font-semibold tracking-tight text-gray-900 mb-3">社区与支持</h2>
          <div className="space-y-3">
            <button
              onClick={() => handleOpenUrl('https://github.com/2ue/ccman')}
              className="flex items-center text-blue-600 hover:text-blue-700 underline decoration-blue-300 decoration-2 underline-offset-2 transition-colors cursor-pointer"
            >
        ...
        {/* 开源协议 */}
        <div className="text-center text-sm text-gray-500 pt-8 mt-8 border-t border-gray-200">
          <p>MIT License © 2024–{new Date().getFullYear()} 2ue</p>
          <p className="mt-1 flex items-center justify-center gap-1">
            用 <Heart className="w-4 h-4 text-red-500 fill-red-500" /> 和好品味构建
          </p>
        </div>
      </div>
    </div>
